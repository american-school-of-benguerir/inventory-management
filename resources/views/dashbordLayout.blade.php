                        ...
                        <ul id="sidebarnav" class="text-sm">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base   flex items-center relative  rounded-md  w-full {{ Request::is('accessories') ? 'active' : '' }}"
                                    ...
                                    <i class="fa-solid fa-ethernet ps-2 text-2xl"></i> <span>Accessories</span>
                                </a>
                            </li>
                            <!-- credentils -->
                            <li class="sidebar-item">
                            ...
                            <!-- Users -->
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base   flex items-center relative  rounded-md  w-full {{ Request::is('users') ? 'active' : '' }}"
                                    href="{{ route('users.index') }}">
                                    <i class="fa-solid fa-user ps-2 text-2xl"></i> <span>Users</span>
                                </a>
                            </li>
                        </ul>
                    </nav>
